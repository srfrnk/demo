...
public class App {
    ...
    public static void main(String[] args) {
        ...
        PCollection<KV<String, String>> linesInput = pipeline
                .apply(KafkaIO.<Long, String>read().withBootstrapServers(KAFKA_BROKER)
                        .withTopic("demo")
                        .withConsumerConfigUpdates(new ImmutableMap.Builder<String, Object>()
                                .put(ConsumerConfig.GROUP_ID_CONFIG, "kafka2kafka")
        ...
        linesOutput
                ...
                .apply(KafkaIO.<Void, String>write().withBootstrapServers(KAFKA_BROKER)
                        .withTopic("demo_enriched").withValueSerializer(StringSerializer.class)
                        .values());
        pipeline.run();
    }
}
